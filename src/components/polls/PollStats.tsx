// src/components/poll/PollStats.tsx
...
const PollStats: React.FC<PollStatsProps> = ({ stats }) => {
  const positivePercentage = stats.totalVotes > 0 
    ? ((stats.positiveCount / stats.totalVotes) * 100).toFixed(1)
    : '0';
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <StatsCard
        ...
        description={`${positivePercentage}%`}
        color="green"
        icon={
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
